...
void Shop::create() {
    ...
    m_leftArrow.setScale(PLAYER_SCALE / 2, PLAYER_SCALE / 2);
            ...
            switch (event.type) {
                ...
                case sf::Event::MouseMoved: {
                    if (m_leftArrow.getGlobalBounds().contains(sf::Vector2f(event.mouseMove.x, event.mouseMove.y))) {
                        m_leftArrow.setScale(PLAYER_SCALE / 1.5, PLAYER_SCALE / 1.5);              //Increase left arrow size by 20%
                        m_rightArrow.setScale(PLAYER_SCALE / 2, PLAYER_SCALE / 2); //Reset right arrow size
                    }
                    else if (m_rightArrow.getGlobalBounds().contains(sf::Vector2f(event.mouseMove.x, event.mouseMove.y))) {
                        m_rightArrow.setScale(PLAYER_SCALE / 1.5, PLAYER_SCALE / 1.5);             //Increase right arrow size by 20%
                        m_leftArrow.setScale(PLAYER_SCALE / 2, PLAYER_SCALE / 2); //Reset left arrow size
